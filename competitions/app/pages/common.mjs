...
import { KIND, compDTag, isCompId, parseDTag } from '../protocol/competition.mjs?v=20260814-5';
import { RelayPool, mergeRelays } from '../protocol/relay-pool.mjs';
import { isLoopbackRelay } from '../protocol/relay-url.mjs';
import { CompetitionStore } from '../ui/store.mjs?v=20260814-2';
import { createTranslator, detectLanguage } from '../ui/i18n.mjs?v=20260814-6';
