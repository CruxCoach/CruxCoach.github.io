...
export function renderStatsBlock(features, meta, lang = 'en') {
  ...
  return `<p>
    ...
    ${boardCountsTable(features, meta, lang)}${linked}${hours}${sourceFreshnessTable(meta, lang)}
    <p>
...
<main>
  <div class="container">
    ...
    ${boardCountsTable(features, meta, lang)}${linkedNote}${hoursNote}${sourceFreshnessTable(meta, lang)}
